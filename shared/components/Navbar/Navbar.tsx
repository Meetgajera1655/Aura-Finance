    ...
    <>
      ...
      <header 
        className={`fixed top-0 left-0 right-0 z-50 w-full flex flex-col transition-all duration-300 ${
          isScrolled 
            ? "bg-white/90 dark:bg-black backdrop-blur-xl border-b border-gray-200/50 dark:border-gray-800 shadow-sm supports-[backdrop-filter]:bg-white/60 dark:supports-[backdrop-filter]:bg-black/90" 
            : "bg-transparent dark:bg-black border-b-0 dark:border-gray-800"
        }`}
      >
            ...
            >
              <div className="flex items-center space-x-2">
                <div className="relative flex items-center justify-center transition-all duration-300">
                  <LogoIcon className="w-10 h-10 text-blue-600 dark:text-blue-400 transform group-hover:scale-110 transition-transform duration-300" />
                </div>
        ...
        {/* Ticker */}
        <div className="w-full border-t border-gray-100 dark:border-gray-800 bg-gray-50/80 dark:bg-black">
