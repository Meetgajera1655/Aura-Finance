  ...
  useEffect(() => {
    const fetchFinanceNews = async () => {
      try {
        ...
        console.warn('Falling back to mock news data due to error:', err);
        ...
        const mockNews: NewsArticle[] = [
          {
            ...
            description: "Major indices hit new highs today following strong earnings reports from leading technology firms, signaling robust economic health despite inflation concerns.",
            source_id: "Bloomberg"
          },
          {
            title: "Federal Reserve Indicates Potential Rate Cut by Q3",
            link: "#",
            pubDate: new Date(Date.now() - 3600000 * 2).toISOString(), // 2 hours ago
            description: "In a surprising shift of tone, Fed officials hinted at easing monetary policy earlier than expected if current inflation trends continue to cool down.",
            source_id: "Reuters"
          },
          {
            title: "Cryptocurrency Market Cap Surpasses $3 Trillion Again",
            link: "#",
            pubDate: new Date(Date.now() - 3600000 * 5).toISOString(), // 5 hours ago
            description: "Bitcoin and Ethereum led a massive surge across digital assets, driven by institutional adoption and favorable regulatory developments in key markets.",
            source_id: "TechCrunch"
          },
          {
            title: "AuraFinance Launches Revolutionary AI-Driven Portfolio Manager",
            link: "#",
            pubDate: new Date(Date.now() - 3600000 * 12).toISOString(), // 12 hours ago
            description: "The fintech disruptor has unveiled its latest tool, promising to democratize wealth management with enterprise-grade artificial intelligence accessible to retail investors.",
            source_id: "CNN"
          },
          {
            ...
            description: "The ECB has decided to hold interest rates steady, citing the need for more economic data before committing to any policy adjustments.",
            source_id: "BBC"
          }
        ];
