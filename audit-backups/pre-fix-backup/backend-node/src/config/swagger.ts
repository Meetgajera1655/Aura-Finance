...
const options: swaggerJsdoc.Options = {
  definition: {
    openapi: '3.0.0',
    info: {
      title: 'AuraFinance API',
      version: '1.0.0',
      description: 'Comprehensive API documentation for AuraFinance - A financial education and tools platform',
      contact: {
        name: 'AuraFinance Team',
        email: 'support@aurafinance.com',
      },
      license: {
        name: 'MIT',
