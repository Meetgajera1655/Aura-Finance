    ...
    <div className="mx-auto px-4 py-16 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-black min-h-screen transition-colors duration-300">
      <div className="text-center mb-16">
        ...
        <h1 className="text-5xl font-extrabold text-gray-900 dark:text-white mb-6 leading-tight">
          Unlock the Full Power of <span className="text-blue-700 dark:text-blue-400">AuraFinance Premium</span>
        </h1>
          ...
          <ul className="space-y-6 text-lg text-gray-700 dark:text-gray-300">
            {[
              ...
              },
              {
                ...
                description: "Personalize your AuraFinance dashboard with a wider array of widgets and deeper customization options for a tailored experience."
              },
              {
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl p-10 transform hover:scale-[1.02] transition-transform duration-300 ease-in-out">
          ...
          <ul className="space-y-6 text-lg text-gray-700 dark:text-gray-300 mb-12">
            {[
              ...
              },
              {
                ...
                description: "Receive tailored guidance to help you maximize your AuraFinance Premium experience from day one."
              },
              {
                title: "Direct Feedback Channel",
                description: "Have a direct line to our development team for feature requests and suggestions, helping shape the future of AuraFinance."
              },
            ].map((support, idx) => (
              <li key={idx} className="flex items-start">
                <CheckCircle className="h-6 w-6 text-green-500 mr-3 flex-shrink-0 mt-1" />
          ...
          <div className="text-center">
            ...
            <p className="text-xl text-gray-800 dark:text-gray-200 mb-8">
              Join AuraFinance Premium today and experience unparalleled innovation and support.
            </p>
            <Link to="/Pricing">
      ...
      <div className="mt-20 text-center text-gray-600 dark:text-gray-400">
        <p className="text-lg">
          Thousands of developers and analysts trust AuraFinance for their financial innovation needs.
        </p>
