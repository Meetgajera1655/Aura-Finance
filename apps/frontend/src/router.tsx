...
import FlashcardDeckPage from "@/components/Education/FlashCard";
import ChallengePage from "./pages/Education/ChallengePage";
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: "/education/practice/flashcards/:deckId", element: <FlashcardDeckPage /> },
      { path: "/education/challenge/:challengeId", element: <ChallengePage /> },
      { path: "/education/quiz/:quizId", element: <QuizPage /> },
      {
        path: "/",
